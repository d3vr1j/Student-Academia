...
public class UnifiedApp1028 extends JFrame {
    private static final String ATTENDANCE_URL = "jdbc:mysql://localhost:3306/attendanceDB?useSSL=false&serverTimezone=UTC"; // Attendance DB
    private static final String DETAILS_URL = "jdbc:mysql://localhost:3306/studentDetailsDB?useSSL=false&serverTimezone=UTC"; // Student Details DB
    private static final String USER = "root";
    private static final String PASSWORD = "mysystem";
